var gulp            = require('gulp'), // Подключаем Gulp
    ...
    svgStore        = require('gulp-svgstore'),//для создания спратов svg
    //    svgSprite       = require('gulp-svg-sprites');//для создания спратов svg
...
//watch
gulp.task('watch',['browser-sync','font64', 'css-libs', 'scripts','spritesSvg'], function(){//Создаем таск для наблюдение за измененияеми в  файлах
...
gulp.task('build',['clean','img','less', 'scripts', 'css-libs'], function(){//Таск для выгрузки файлов в продакшен
    var buildCss = gulp.src([ // Переносим css-файлы в продакшен
        ...
        'app/css/Roboto-Regular.css',
        'app/css/ralewaysemibold.css',
        'app/css/ralewaybold.css',
        'app/css/ralewayregular.css',
        'app/css/media.css',
        'app/css/header.css'
    ])
    ...
    .pipe(gulp.dest('dist'));
    var buildSvg = gulp.src('app/svg/sprite_svg/sprite.svg') 
